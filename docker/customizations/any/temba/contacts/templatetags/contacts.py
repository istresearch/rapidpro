...
URN_SCHEME_ICONS = {
    ...
    URN.PM_SIGNAL_SCHEME: "icon-signal pm-icon",
    URN.PM_LINE_SCHEME: "icon-line",
    URN.PM_VK_SCHEME: "icon-vk pm-icon",
    URN.PM_VIBER_SCHEME: "icon-viber pm-icon",
    URN.PM_TWITTER_SCHEME: "icon-twitter",
    URN.PM_KAKAO_SCHEME: "icon-tembatoo-kakao pm-icon",
    URN.PM_IMO_SCHEME: "icon-tembatoo-imo pm-icon",
    URN.PM_FACEBOOK_SCHEME: "icon-facebook",
    URN.PM_INSTAGRAM_SCHEME: "icon-tembatoo-instagram pm-icon",
    URN.PM_MOBYX_SCHEME: "icon-tembatoo-mobyx pm-icon",
    URN.PM_FBM_SCHEME: "icon-tembatoo-fbm pm-icon",
