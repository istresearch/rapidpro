...
from engage.contacts.models import PM_Schemes, PM_Scheme_Labels
from temba.contacts.models import URN as TembaURN
TembaURN_Scheme_Choices = (
...
def RunEngageOverrides():
    ...
    TembaURN.SCHEME_CHOICES = TembaURN_Scheme_Choices
    ...
    URN_SCHEME_ICONS.update(engage.contacts.models.PM_Scheme_Icons)
