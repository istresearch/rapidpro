...
PM_CHANNEL_MODES = {
    "ELE":    Schemes_Meta("pm_element",    _("Postmaster Element"),    _("Postmaster Element Identifier"),    "element-chat"),
    ...
    "SIG":    Schemes_Meta("pm_signal",     _("Postmaster Signal"),     _("Postmaster Signal Identifier"),     "signal-chat"),
    ...
    "SESS":   Schemes_Meta("pm_session",    _("Postmaster Session"),    _("Postmaster Session Identifier"),    "icon-session-messenger"),
    "REDDIT": Schemes_Meta("pm_reddit",     _("Postmaster Reddit"),     _("Postmaster Reddit Identifier"),     "icon-reddit"),
    "MAST":   Schemes_Meta("pm_mastodon",   _("Postmaster Mastodon"),   _("Postmaster Mastodon Identifier"),   "icon-mastodon"),
    "YT":     Schemes_Meta("pm_youtube",    _("Postmaster Youtube"),    _("Postmaster Youtube Identifier"),    "icon-youtube"),
    "TIK":    Schemes_Meta("pm_tiktok",     _("Postmaster TikTok"),     _("Postmaster TikTok Identifier"),     "icon-tiktok"),
    "PM":     Schemes_Meta("pm_service",    _("Postmaster Device"),     _("Postmaster Service Channel"),       "icon-postmaster"),
}
